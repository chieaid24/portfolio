...
export default function ExpandedHeader() {
  ...
  // Toggle between Outpost Shop and Smuggler's Den
  const [showSmugglersDen, setShowSmugglersDen] = useState(false);
        ...
        <div className="flex justify-between items-start">
          <div>
            ...
            <p className="text-2xl font-semibold mt-1 flex items-center gap-1">
              ₳ 1.42k <span className="text-neutral-500 text-sm">ⓘ</span>
            </p>
          </div>
          ...
          <section>
            ...
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-sm font-semibold text-neutral-300 tracking-wide">
                {showSmugglersDen ? "Smuggler's Den" : "Outpost Shop"}
              </h2>

              <button
                onClick={() => setShowSmugglersDen((prev) => !prev)}
                className="
                  p-2
                  rounded-full
                  ...
                  transition
                "
                aria-label="Toggle Smuggler's Den"
              >
                <svg
                  width="22"
                  height="22"
                ...
                >
                  <path d="M12 4l-3 3h2v5h2V7h2l-3-3z" />
                  <path d="M12 20l3-3h-2v-5h-2v5H9l3 3z" />
                </svg>
              </button>
            </div>
            ...
            <AnimatePresence mode="wait">
                    ...
                    >
                      {themes.map((item) => {
                        ...
                        return (
                          ...
                          >
                            <p
                              className={`text-xs mb-2 font-medium ${statusColor}`}
                            >
                              {statusText}
                            </p>
              ...
              {showSmugglersDen && (
                <motion.div
                  ...
                  exit={{ opacity: 0, x: -40 }}
                  transition={{ duration: 0.35 }}
                  className="bg-[#111113] border border-neutral-800 rounded-xl p-6 text-neutral-300"
                >
                  <h3 className="text-lg font-bold mb-3 text-red-300">
                    Smuggler&apos;s Den
                  </h3>
                  <p className="text-sm text-neutral-400 mb-4">
                    A shady wing of the Outpost reserved for experimental,
                    risky, and probably ill-advised features.
                  </p>

                  <div className="mt-2 grid gap-3 text-xs text-neutral-400">
                    <div className="flex items-center justify-between bg-black/40 border border-red-900/50 rounded-lg px-3 py-2">
                      <span>Access Level</span>
                      <span className="text-red-300 font-semibold">
                        RESTRICTED
                      </span>
                    </div>
                    <div className="flex items-center justify-between bg-black/40 border border-neutral-800 rounded-lg px-3 py-2">
                  ...
                  <p className="text-[0.7rem] text-neutral-500 mt-4">
                    Placeholder: wire this up to whatever cursed systems you
                    dream up later. For now, it&apos;s just flavor text and
                    atmosphere.
                  </p>
                </motion.div>
              )}
