...
export default function ModelViewer({
  ...
  return (
    <div className="relative h-full w-full">
      ...
      <div
        className={`border-outline-dark-gray relative aspect-[16/8] w-full cursor-grab overflow-hidden rounded-lg border bg-gray-200 shadow-md active:cursor-grabbing`}
        onPointerEnter={(e) => {
