          ...
          <div className="text-body-text min-h-[90vh]">
            <div className="mb-6 grid grid-cols-1 pt-35 md:grid-cols-2 md:pt-40">
              <div className="order-2 md:order-1">
                <h1 className="bg-background mb-4 text-xl font-bold tracking-[0.2em] text-main-text sm:text-2xl md:mb-8 md:text-3xl">
                  About Me
                </h1>
                {/* blurb section*/}
            ...
            <div className="flex flex-col space-y-6 md:space-y-7">
              <div className="mb-8">
                <h1 className="mb-4 text-xl font-bold tracking-[0.2em] text-main-text sm:text-2xl md:mb-8 md:text-3xl">
                  Interests
                </h1>
